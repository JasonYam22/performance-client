  ...
  return (
    <div className="relative min-h-screen bg-[#14161B] text-[#F3F1ED] overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        {/* Identity card — username & email, read-only */}
        <div className="rounded-3xl border-2 border-[#3A3D42] bg-[#262A33]/80 backdrop-blur-sm p-6 flex flex-col sm:flex-row gap-6">
          <div className="flex items-center gap-4 flex-1">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#F3F1ED]/10">
              <User className="w-5 h-5 text-[#F3F1ED]" />
            </div>
            <div>
              <h3 className="text-xs uppercase tracking-widest text-[#A6ABB2] font-semibold">Username</h3>
              <p className="text-lg font-bold">{user?.username || "—"}</p>
            </div>
          </div>

          <div className="flex items-center gap-4 flex-1 sm:border-l-2 sm:border-[#3A3D42] sm:pl-6">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#F3F1ED]/10">
              <Mail className="w-5 h-5 text-[#F3F1ED]" />
            </div>
            <div>
              <h3 className="text-xs uppercase tracking-widest text-[#A6ABB2] font-semibold">Email</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-3xl border-2 border-[#FFC94F]/50 bg-[#262A33]/80 backdrop-blur-sm p-6 flex items-center gap-4 shadow-[0_0_40px_-12px_#FFC94F]">
            ...
            <div>
              ...
              <p className="text-2xl font-['Archivo_Black'] text-[#FFC94F]">
                {user?.dailyCalorieGoal != null ? user.dailyCalorieGoal : "Not set"} (kcal)
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border-2 border-[#4FA8FF]/50 bg-[#262A33]/80 backdrop-blur-sm p-6 flex items-center gap-4 shadow-[0_0_40px_-12px_#4FA8FF]">
            ...
            <div>
              ...
              <p className="text-2xl font-['Archivo_Black'] text-[#4FA8FF]">
                {user?.weeklyWorkoutGoal != null ? user.weeklyWorkoutGoal : "Not set"} (x / week)
              </p>
            </div>
          </div>
        </div>
